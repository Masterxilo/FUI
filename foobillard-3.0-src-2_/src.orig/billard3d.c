...
static struct option long_options[] =
{
    ...
    {"blackwhite",   no_argument,       (int *)"balck table with white frame",      OPT_BLACKWHITE},
    ...
    {"lensflare",    no_argument,       (int *)"turn on lensfare",                  OPT_LENSFLARE},
    {"nolensflare",  no_argument,       (int *)"turn off lensfare",                 OPT_NOLENSFLARE},
...
//    {"host",         required_argument, (int *)"arg=IP play network game with IP as host",        OPT_HOST},
    ...
    {"cuberef",      required_argument, (int *)"arg=on|off rendered cubemep reflections",         OPT_CUBEREF},
...
/*       case OPT_NETGAME:     player[1].is_net=1;    player[0].is_net=0;
       ...
       case OPT_BALLTRACE:   switch(optarg[1]){
                             ...
                             break;
       case OPT_GAMEMODE:    if       (strncasecmp("match",optarg,5)==0){
...
/*       case OPT_POSLIGHT:    options_positional_light=1; break;
       case OPT_DIRLIGHT:    options_positional_light=0; break;*/
        ...
        case OPT_GEOMETRY:    sprintf(str,"%dx%d",win_width,win_height); write_rc(f,opt,str); break;
...
//                  PlaySound(&ball_wall_snd,(whitstrength*0.125>1.0)?1.0:whitstrength*0.125);
               }
...
/*#ifdef USE_SDL
       if(bhitstrength!=0.0){
           PlaySound(&ball_ball_snd,(bhitstrength*0.25>1.0)?1.0:bhitstrength*0.25);
       }
       if(whitstrength!=0.0){
           PlaySound(&ball_wall_snd,(whitstrength*0.125>1.0)?1.0:whitstrength*0.125);
       }
